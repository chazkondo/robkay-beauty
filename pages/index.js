    ...
    <div id="Home" className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content={
            "Robkay Beauty - " + props.text.intro + ". " + props.text.caption2
          }
        />
        ...
        <meta
          property="og:image"
          content="https://robkaybeauty.com/robyn.png"
        />
        <link
          rel="preload"
        ...
        <link
          rel="preload"
          href="/fonts/Playlist-Script.otf"
          as="font"
          crossOrigin=""
        />
      ...
      >
        ...
        >
            ...
            <div className="menu">
              <div>
                <div>
                  <ul>
                    <li>
                      <a onClick={() => toggleMenuStateOff()} href="#Home">
                        Home
                      </a>
                    </li>
                    <li>
                      <a onClick={() => toggleMenuStateOff()} href="#About">
                        About
                      </a>
                    </li>
                    <li>
                      <a onClick={() => toggleMenuStateOff()} href="#OurWork">
                        Our Work
                      </a>
                    </li>
                    <li>
                      <a onClick={() => toggleMenuStateOff()} href="#Services">
                        Services
                      </a>
                    </li>
                    <li>
                      <a
                        onClick={() => toggleMenuStateOff()}
                        href="mailto: robkaymua@gmail.com"
                      >
                        Contact
                      </a>
                    </li>
          ...
          >
            ...
            <li>
              <a href="mailto: robkaymua@gmail.com">Contact</a>
            </li>
          </ul>
        </div>
      </div>
